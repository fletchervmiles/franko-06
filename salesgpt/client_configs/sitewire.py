...
<extraction_question>Hi there, this is Francesca! I'm super excited to chat with you today! So, before we kick things off. I want to let you know that the purpose of our call is to discuss your experience with Sitewire. The interview will be recorded, shared with the team and take approximately 30 minutes.<break time="0.75s" />Ok, now that's covered, are you in a quiet place and ready to get started?</extraction_question>
        """
    },
...
- Avoid asking about Sitewire or follow this line of questioning for now. Ignore it. This is because this topic will have a specific section later in the interview. For now, it’s about understanding the interviewee.
...
<extraction_question>Ok, before we move on to the next section, what’s one thing you absolutely love about your work and what’s one thing you don’t love so much? Just let me know whatever comes to mind.</extraction_question>
    ...
    "5": {
        "category": "verbatim",
        "content": """
GOAL 5: INTERVIEW SECTION: INTERVIEW SECTION: DISCOVERY - VERBATIM

Extraction Question

<extraction_question>Ok, we’re making great progress. Let’s move on. I want to discuss how you first discovered Sitewire. <break time="0.5s" />For example, was it a recommendation, or maybe you had been searching for a similar tool or saw an ad. So over to you, <break time="0.5s" /> can you remember how and when you came across Sitewire?</extraction_question>
        """
    },
    ...
    "6": {
        "category": "exploratory",
        "content": """
GOAL 6: INTERVIEW SECTION: INTERVIEW SECTION: DISCOVERY - EXPLORATORY

As a founder, I want to understand:

The complete story of how the interviewee first discovered Sitewire, focusing on:
- The conditions and context when they encountered Sitewire.
...
- Use any gaps or uncertainties in their responses to investigate further aspects of their discovery narrative, such as motivations or unforeseen needs that led to using Sitewire.

Things to avoid:

- Avoid asking about the Sitewire’s features or benefits. This is because this topic will have a specific section later in the interview. For now, it’s about understanding the interviewee and their experiences and preferences.
...
GOAL 7: INTERVIEW SECTION: INTERVIEW SECTION: POINT OF CONVERSION - VERBATIM

Extraction Question

<extraction_question>Ok, just before we move into a discussion about your initial experiences, I'd like to ask one more thing. <break time="0.75s" /> When you ultimately made the decision to start using Sitewire, was there anything that made you hesitate or have second thoughts? <break time="0.25s" /> And I guess if so, what ultimately convinced you to go ahead anyway?</extraction_question>
        """
    },
    ...
    "8": {
        "category": "verbatim",
        "content": """
GOAL 8: INTERVIEW SECTION: INTERVIEW SECTION: EXPERIENCE AND PERCEPTIONS - VERBATIM

Extraction Question:

<extraction_question>Alright, thanks for sharing how you first discovered Sitewire. <break time="0.75s" /> By the way, you’re awesome {interviewee_name}, I’m really enjoying our conversation. <break time="0.75s" /> Now, let’s progress to discussing Sitewire itself. <break time="0.5s" /> So, tell me, how often are you using it and what are you mostly using it for? <break time="0.4s" /> Basically, I’d really just love to get a sense of your overall experience with Sitewire so far.</extraction_question>
        """
    },
    ...
    "9": {
        "category": "exploratory",
        "content": """
GOAL 9: INTERVIEW SECTION: INTERVIEW SECTION: EXPERIENCE AND PERCEPTIONS - EXPLORATORY
...
- Avoid asking for specifics or challenges. Focus on learning more, asking questions that allow the interviewee to give you a story in their own words. You’re there to listen and let their story unfold, not ask them corporate jargon like “what are your pain points?” AVOID THIS.
    ...
    "10": {
        "category": "verbatim",
        "content": """
GOAL 10: INTERVIEW SECTION: INTERVIEW SECTION: RELATIVE FEATURE PREFERENCE - VERBATIM

Extraction Question:

<extraction_question>Ok, thanks for that! You’re really smashing this! We’re making great progress. Let’s try a new format. <break time="0.25s" />  I’m going to list 6 of the main Sitewire features <break time="0.25s" /> And then I’ll ask you to pick the feature that is most important to you.

<break time="0.5s" />

Ok, so here they are: 

1. Draw & Progress Management:<break time="0.25s" />Efficient draw management for construction lenders and asset managers.

<break time="0.5s" />

2. Pre-Close Walkthrough:<break time="0.25s" />Instant pre-close walkthroughs for underwriting teams.

<break time="0.5s" />

3. Same Day Draw Inspections:<break time="0.25s" /> Same day virtual draw inspections for construction lending.

<break time="0.5s" />

4. Site Health Checks<break time="0.25s" />Site Check for proactive project oversight.

<break time="0.5s" />

5. Draw Insurance<break time="0.25s" />Insure your draw operations against fraud.

<break time="0.5s" />

6.Payments<break time="0.25s" />One-click draw disbursement for lenders.


<break time="0.5s" /> Quick recap… 1. Draw & Progress Management, 2. Pre-Close Walkthrough, 3. Same Day Draw Inspections, 4. Site Health Checks, 5. Draw Insurance, and 6. One-click draw disbursement Payments. So {interviewee_name},<break time="0.5s" /> which is the most important to you and why?</extraction_question>
        """
    },
    ...
    "11": {
        "category": "verbatim",
        "content": """
GOAL 11: INTERVIEW SECTION: INTERVIEW SECTION: RELATIVE FEATURE PREFERENCE - VERBATIM

Extraction Question:

<extraction_question>So, you can probably guess what is coming next <break time="0.75s" />. Of the previously listed features, <break time="0.5s" /> which is the least important to you and why? <break time="0.5s" /> Here are the options again. 1. Draw & Progress Management, 2. Pre-Close Walkthrough, 3. Same Day Draw Inspections, 4. Site Health Checks, 5. Draw Insurance, and 6. One-click draw disbursement Payments. So,<break time="0.4s" /> which is the least important to you and why?</extraction_question>
        """
    },
    ...
    "12": {
        "category": "verbatim",
        "content": """
GOAL 12: INTERVIEW SECTION: INTERVIEW SECTION: MAIN BENEFITS - VERBATIM
...
Next up, I’d love it if you could describe to me, in your own words and in as much detail as possible please, the most significant benefit you receive from Sitewire? 
...
Remember, your opinions are really valuable so take as much time as you need.</extraction_question>
    ...
    "13": {
        ...
        "content": """
GOAL 13: INTERVIEW SECTION: INTERVIEW SECTION: MAIN BENEFITS - CONCRETE
...
- E.g. So, to recap, the main benefit to you is streamlining your draw management process.
- E.g. Alright, so in summary, the main benefit for you is the real-time budget management, cool!
...
- E.g. Perhaps think back to the last time you were using Sitewire.
- E.g. Think back to the last big problem you had on your construction project.


Part 4 - Encouragement
- Encourage them to give a good response, sometimes concrete examples are difficult for interviewees

- E.g. These questions can be a bit tough for participants but it’ll be super valuable to the Sitewire team - so please give it some thought!” 
...
- Avoid asking for specifics or challenges. Focus on learning more, asking questions that allow the interviewee to give you a story in their own words. You’re there to listen and let their story unfold, not ask them corporate jargon like “what are your pain points?” AVOID THIS.
    ...
    "14": {
        "category": "exploratory",
        "content": """
GOAL 14: INTERVIEW SECTION: INTERVIEW SECTION: MAIN BENEFITS - EXPLORATORY

Context:

In the recent conversation history, we have asked the interviewee about the main benefit they receive from Sitewire.
...
- Avoid asking for specifics or challenges. Focus on learning more, asking questions that allow the interviewee to give you a story in their own words. You’re there to listen and let their story unfold, not ask them corporate jargon like “what are your pain points?” AVOID THIS.
    ...
    "15": {
        "category": "verbatim",
        "content": """
GOAL 15: INTERVIEW SECTION: INTERVIEW SECTION: IMPROVEMENT - VERBATIM
...
Let’s keep things moving, next up, you’re going to love this,<break time="0.5s" />I want to understand how the team at Sitewire could improve the product for you.

<break time="0.5s" />

So, can you think of any feedback, <break time="0.4s" />feature requests<break time="0.4s" /> or generally anything that you think would help to improve Sitewire?</extraction_question>
        """
    },
    ...
    "16": {
        "category": "exploratory",
        "content": """
GOAL 16: INTERVIEW SECTION: INTERVIEW SECTION: IMPROVEMENT - EXPLORATORY

Context:

In the recent conversation history, we have asked the interviewee any improvements they have in mind for Sitewire.
...
- Avoid asking for specifics or challenges. Focus on learning more, asking questions that allow the interviewee to give you a story in their own words. You’re there to listen and let their story unfold, not ask them corporate jargon like “what are your pain points?” AVOID THIS.
    ...
    "17": {
        "category": "verbatim",
        "content": """
GOAL 17: INTERVIEW SECTION: INTERVIEW SECTION: COMPETITOR DIFFERENTIATION - VERBATIM
...
So, to kick things off, prior to using Sitewire, have you used any other similar construction software tools?</extraction_question>
        """
    },
    ...
    "18": {
        "category": "exploratory",
        "content": """
GOAL 18: INTERVIEW SECTION: INTERVIEW SECTION: COMPETITOR DIFFERENTIATION - EXPLORATORY

As a founder, I want to understand

The following questions
- What was the interviewee using prior to Sitewire, if anything 
...
- Did they research competitors or try other products prior to deciding on Sitewire?
- Determine and investigate how the interviewee perceives Sitewire vs competitors - i.e. perceptions of key differentiators
...
This just gives more data around how the customers are coming to the product, the context of them switching, i.e. their problem, and Sitewires positioning relative to competitors.
...
- Avoid asking for specifics or challenges. Focus on learning more, asking questions that allow the interviewee to give you a story in their own words. You’re there to listen and let their story unfold.
    ...
    "19": {
        "category": "verbatim",
        "content": """
GOAL 19: INTERVIEW SECTION: INTERVIEW SECTION: RELATIVE DISAPPOINTMENT - VERBATIM
...
How would you feel if you could no longer use Sitewire? <break time="0.75s" />
...
Just pick one and if you can, give a short explanation as to why.</extraction_question>
    ...
    "20": {
        "category": "verbatim",
        "content": """
GOAL 20: INTERVIEW SECTION: INTERVIEW SECTION: PRICE SENSITIVITY- VERBATIM
...
Ok, here we go. First pricing question. <break time="0.5s" />At what point would you consider Sitewire way too expensive? Like, soooo expensive that you would never consider purchasing it?</extraction_question>
        """
    },
    ...
    "21": {
        "category": "verbatim",
        "content": """
GOAL 21: INTERVIEW SECTION: INTERVIEW SECTION: PRICE SENSITIVITY- VERBATIM

Extraction Question:

<extraction_question>Next up. At what point would you consider Sitewire to be starting to get expensive, but you’d still consider purchasing it?</extraction_question>        """
    },
    ...
    "22": {
        "category": "verbatim",
        "content": """
GOAL 22: INTERVIEW SECTION: INTERVIEW SECTION: PRICE SENSITIVITY- VERBATIM

Extraction Question:

<extraction_question>Alright, almost there. And at what price point would you consider Sitewire to be a really good deal? Like, you’d buy it right away.</extraction_question>
        """
    },
...
<extraction_question>And Final pricing question, here we go! So, at what price point is Sitewire way too cheap that you’d question the quality of it? Like, strangely cheap.</extraction_question>
        """
    },
...
<extraction_question>Ok, we’re so close to the end now. This is the second to last section and then we’re done! So stay with me! So, we’ve discussed a bunch about your experience and thoughts on Sitewire. As you reflect on this, I’d love to know, what type of people do you think would most benefit from using Sitewire?</extraction_question>
    ...
    "25": {
        "category": "exploratory",
        "content": """
GOAL 25: INTERVIEW SECTION: INTERVIEW SECTION: IDEAL USER AND WORLD OF MOUTH - EXPLORATORY

As a founder, I want the interviewee to describe in their own words who they think would benefit most from using Sitewire.

- If their description of the user is shallow, follow up and ask for further details
- If they have described a user, investigate whether they have recommended Sitewire to this user type and if so, explore the conversation such as
  - what aspects of Sitewire they highlighted 
...
This helps us understand the interviewees perceptions of Sitewire and the language they use to describe it to friends and colleagues.
...
- Avoid asking for specifics or challenges. Focus on learning more, asking questions that allow the interviewee to give you a story in their own words. You’re there to listen and let their story unfold.
    ...
    "26": {
        "category": "verbatim",
        "content": """
GOAL 26: INTERVIEW SECTION: INTERVIEW SECTION: OPEN FEEDBACK AND CLOSING - VERBATIM
...
So, any final words of wisdom for the Sitewire team?</extraction_question>
        """
    },
    ...
    "27": {
        "category": "closing",
        "content": """
GOAL 27: INTERVIEW SECTION: INTERVIEW SECTION: CLOSING - CLOSING
...
GOAL_TARGET_NUMBERS = {
    ...
    "7": [0, 0, 00, 00, 000], #Verbatim - Point of Conversation
    "8": [0, 0, 00, 00, 000], #Verbatim - Experience and Perceptions
    "9": [2, 2, 00, 00, 000], #Exploratory - Experience and Perceptions
    "10": [0, 0, 00, 00, 000], #Verbatim - Experience and Perceptions
    "11": [0, 0, 00, 00, 000], #Verbatim - Experience and Perceptions
    "12": [0, 0, 00, 00, 000], #Verbatim - Main Benefits
    "13": [0, 0, 00, 00, 000], #Concrete - Main Benefits
    "14": [2, 2, 00, 00, 000], #Exploratory - Main benefits
    "15": [0, 0, 00, 00, 000], #Verbatim - Improvements
    "16": [2, 2, 00, 00, 000], #Exploratory - Improvements
    "17": [0, 0, 00, 00, 000], #Verbatim - Competitor Differentiation
    "18": [1, 1, 00, 00, 000], #Exploratory - Competitor Differentiation
    "19": [0, 0, 00, 00, 000], #Verbatim - Relative Disappointment
    "20": [0, 0, 00, 00, 000], #Verbatim - Price Sensitivity
    "21": [0, 0, 00, 00, 000], #Verbatim - Price Sensitivity
    "22": [0, 0, 00, 00, 000], #Verbatim - Price Sensitivity
    "23": [0, 0, 00, 00, 000], #Verbatim - Price Sensitivity
    "24": [0, 0, 00, 00, 000], #Verbatim - Ideal User and Word of Mouth
    "25": [1, 1, 00, 00, 000], #Exploratory - Ideal User and Word of Mouth
    "26": [0, 0, 00, 00, 000], #Verbatim - Open Feedback and Closing
    "27": [1000, 1000, 1000, 1000, 1000] #Closing - Closing
}

CLIENT_PRODUCT_SUMMARY = """
SiteWire is a digital platform focused on optimizing construction lending through advanced software solutions. Its services include:
- Same-Day Virtual Draw Inspections: Enables rapid, real-time verification of construction progress through virtual inspections.
- 360° Real-Time Budget Management: Offers dynamic tools for monitoring and managing project budgets.
- Progress Monitoring: Ensures continuous oversight from project inception to completion.
- Pre-Close Walkthroughs: Provides virtual checks for project readiness before closing.
- Site Health Checks: Monitors the safety and overall condition of construction sites.
- Draw Insurance & Payments: Protects capital investment and simplifies payment processes.
- 3D Technology & AI-Driven Analytics: Incorporates AI and 3D tools to improve project assessment and management.
The platform is designed for lenders, borrowers, and construction professionals, offering solutions to streamline workflows, reduce fraud, and accelerate capital turnover. With an API and offline apps, SiteWire integrates easily into existing processes, making it scalable across markets, including real estate and construction.
SiteWire’s tools aim to enhance operational efficiency, reduce risk, and optimize project outcomes for businesses in construction lending.
