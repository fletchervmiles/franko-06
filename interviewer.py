    ...
    try:
        ...
        response = vonage_client.voice.create_call({
            ...
            'ncco': [
                {
                    'action': 'record',
                    'eventUrl': [f'https://0b56-184-82-29-177.ngrok-free.app/vonage_recording?call_id={call_id}'],
                    'format': 'mp3'
                },
                {
                    'action': 'connect',
                    'endpoint': [
                        {
                            'type': 'websocket',
                            'uri': f'wss://0b56-184-82-29-177.ngrok-free.app/ws?call_id={call_id}',
            ...
            'event_url': [f'https://0b56-184-82-29-177.ngrok-free.app/vonage_call_status?call_id={call_id}'],
            'event_method': 'POST'
        })
