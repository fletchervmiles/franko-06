    ...
    try:
        ...
        response = vonage_client.voice.create_call({
            ...
            'ncco': [
                {
                    'action': 'record',
                    'eventUrl': [f'https://a9aa-184-82-30-37.ngrok-free.app/vonage_recording?call_id={call_id}'],
                    'format': 'mp3'
                },
                {
                    'action': 'connect',
                    'endpoint': [
                        {
                            'type': 'websocket',
                            'uri': f'wss://a9aa-184-82-30-37.ngrok-free.app/ws?call_id={call_id}',
            ...
            'event_url': [f'https://a9aa-184-82-30-37.ngrok-free.app/vonage_call_status?call_id={call_id}'],
            'event_method': 'POST'
        })
